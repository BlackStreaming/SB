...
import { useAuth } from '/src/context/AuthContext';import React, { useState, useEffect } from 'react';
import { Routes, Route, Navigate, Link, useLocation, useNavigate } from 'react-router-dom';
import { 
    FiDollarSign, 
    FiShoppingBag, 
...
const styles = {
    layout: {
        display: 'flex',
        // Aseguramos que el layout principal tenga al menos 100vh
        minHeight: '100vh', 
    ...
    // Estilos base del Sidebar (Escritorio y Overlay Móvil)
    sidebar: {
        width: '280px',
    ...
    // ✅ SOLUCIÓN SCROLL SIDEBAR: Usamos flex: 1 y overflowY: auto
    navContainer: {
        flex: 1, // Ocupa el espacio disponible para empujar el logout abajo
        overflowY: 'auto', // Permite el scroll solo en la lista de enlaces
        display: 'flex',
        flexDirection: 'column',
        gap: '8px',
        padding: '0 16px'
    ...
    content: {
        ...
        position: 'relative',
        zIndex: 1,
        height: '100vh', // Se ajusta a la altura del viewport
        overflow: 'hidden', // Evita el scroll en el content
        display: 'flex',
        flexDirection: 'column',
    },
    mobileHeader: {
    ...
    mainContent: {
        padding: '32px',
        flexGrow: 1,
        overflowY: 'auto', // Permite el scroll en el contenido de la página
    },
    mobileLogo: {
        height: '28px',
        width: 'auto'
    ...
    return (
        <>
            ...
            <div style={sidebarStyle}>
                ...
                {/* Este contenedor es el que maneja el scroll de los enlaces */}
                ...
                {/* BOTÓN CERRAR SESIÓN (footerContainer) - Permanece visible */}

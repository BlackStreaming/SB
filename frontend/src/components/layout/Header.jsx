...
// 1. IMPORTACIÓN DEL LOGO (Ruta ajustada: sube 2 niveles para llegar a 'images')
      ...
      <header className="main-header">
        <div className="header-content">
          ...
          <Link to="/" className="logo-container">
            {/* 2. USO DE LA VARIABLE IMPORTADA */}
            <img src={LogoBlack} alt="BlackStreaming" className="logo-img" />
          </Link>
